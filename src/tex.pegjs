...
// if "input" is trimed and some of it are removed from the original input
// peg$computePosDetails will tranlate the location to match the original one
peg$computePosDetails = function (pos) {

  //#region translating pos to the original position
  let incre = 0;
  ...
  //#region the original function auto-generated by pegjs
